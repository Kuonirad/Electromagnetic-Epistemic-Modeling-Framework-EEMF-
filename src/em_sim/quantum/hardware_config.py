...
class HardwareConfig:
    ...
    def create_superconducting(cls) -> "HardwareConfig":
        ...
        return cls(
            ...
            decoherence_times={"T1": 100e-6, "T2": 150e-6},  # 100 μs  # 150 μs
            gate_errors={"single_qubit": 1e-3, "two_qubit": 1e-2},
        )
    ...
    def create_trapped_ion(cls) -> "HardwareConfig":
        ...
        return cls(
            ...
            connectivity_map={
                i: list(range(10)) for i in range(10)
            },  # All-to-all
            decoherence_times={"T1": 10.0, "T2": 1.0},  # 10 s  # 1 s
            gate_errors={"single_qubit": 1e-4, "two_qubit": 1e-3},
        )
